...
<header>
    <nav>
        <ul>
            ...
            <li><a href="#">For Course Creators</a></li>
            <li><a href="#">Explore Courses</a></li>
            <li><a href="#">Pricing</a></li>
            <li><a href="#" class="cta">Sign Up | Login</a></li>
        </ul>
    </nav>
</header>
...
<section class="hero">
    ...
    <div class="marketing-copy">
        <!--Engage. <br>Learn.<br> Create. Harness the power of AI to unlock personalized educational conversations.-->
        <img src="Engage.png" alt="Marketing Image" style="width: 80%; max-width: 400px; height: auto;" />
    </div>
    <!--div class="cta-group">
...
<section class="features">
    ...
    <div class="feature">
        ...
        <h3>AI-assisted Course Creation</h3>
        <!--p>Automatically generate comprehensive courses in minutes.</p-->
    </div>
    <div class="feature">
    ...
    <div class="feature">
        ...
        <!--p>Adaptable learning that utilizes data-driven insights to maximize learning outcomes.</p-->
    </div>
</section>
</body>
</html>
